...
//   // Predefined Hostel List
//   String? _selectedHostel;
  
//   final TextEditingController _phoneController = TextEditingController(text: "+91 91101 XXXXX");
...
//                   backgroundColor: const Color(0xFFFF8C00), // Marigold
...
//         border: Border.all(color: const Color(0xFFFFB74D).withOpacity(0.1)),
//       ),
//       child: Column(
//         crossAxisAlignment: CrossAxisAlignment.start,
//         children: [
...
//                   style: TextStyle(fontSize: 10, fontWeight: FontWeight.w900, color: const Color(0xFFFFB74D).withOpacity(0.8), letterSpacing: 1)),
//             ],
//           ),
//           const SizedBox(height: 12),
//           const Text("User Name", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
//           const Text("user.1@iitj.ac.in", style: TextStyle(fontSize: 12, color: Color(0xFF94A3B8))),
//           const SizedBox(height: 12),
//           const Text("Name and Email are derived from your institutional ID and cannot be modified.", 
...
//       child: Text(label, style: const TextStyle(fontSize: 11, fontWeight: FontWeight.w900, color: Color(0xFF94A3B8), letterSpacing: 1)),
//     );
//   }
...
//           items: AppConstants.hostels.map((h) => DropdownMenuItem(value: h,
//               child: Row(children: [
//                 const Icon(Icons.apartment, color: Color(0xFFFFB74D), size: 18),
