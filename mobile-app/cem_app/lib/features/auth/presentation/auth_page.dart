...
//                 children: [TextSpan(text: "CEM"), TextSpan(text: ".", style: TextStyle(color: Color(0xFFFFB74D))), TextSpan(text: "IITJ")],
//               ),
//             ),
...
//             _buildPrimaryButton("SIGN IN", onTap: _handleSignIn),
...
//                   items: _hostels.map((e) => DropdownMenuItem(
//                     value: e, 
...
//             ),
//             const SizedBox(height: 20),
//             _buildInputCard(title: "SET PASSWORD", hint: "••••••••", isPassword: true),
//             const SizedBox(height: 40),
