...
//         ),
//         title: const Text("My Listings", style: TextStyle(fontWeight: FontWeight.w900, fontSize: 18)),
//       ),
//       body: StreamBuilder<List<Listing>>(
//         // Logic: Later replace with service.getUserListings(currentUserId)
...
//           // --- 2. ACTIVE LISTINGS VIEW ---
//           return ListView.builder(
//             padding: const EdgeInsets.all(24),
//             itemCount: listings.length,
//             itemBuilder: (context, index) => _buildManageableCard(listings[index]),
//           );
//         },
//       ),
//     );
...
//   Widget _buildManageableCard(Listing item) {
//     return Container(
...
//                 Row(
//                   children: [
//                     _buildSmallIconBtn(Icons.edit_note_outlined, Colors.white60),
//                     const SizedBox(width: 12),
//                     _buildSmallIconBtn(Icons.delete_outline, Colors.redAccent.withOpacity(0.7)),
//                   ],
//                 ),
//               ],
//             ),
//           ),
//           // Checkmark Action (Mark as Sold)
//           Container(
//             width: 55, height: 55,
//             decoration: BoxDecoration(
